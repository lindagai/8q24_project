...
filepath.geno <- "/users/lgai/8q24_project/data/processed_data/geno_matrix/filtered/8q24.cleaned.phased.filtered.annotation.rarevar.monomorphs.removed.rds"
filepath.rvTDT.ped<-"/users/lgai/8q24_project/data/processed_data/rvTDT/ped/8q24.cleaned.phased.filtered.annotation.rarevar.monomorphs.removed.ped"
