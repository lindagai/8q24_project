...
#Author: Linda Gai
#Last update: 3/12/18
#Changed filepaths to new project folder
...
#Read in pedfile
filepath_ped<-"/users/lgai/8q24_project/data/raw_data/gmkf_euro_completetrios.csv"
...
#In Terminal, run this command in the directory where the vcf file is:
...
# 
# vcf_gt_path<-"/users/lgai/8q24_project/data/raw_data/vcfs/8q24.recode.GT.GT.FORMAT"
# 
...
# head(vcf_ids)
# 
# vcf_ids_path<-"/users/lgai/8q24_project/data/processed_data/vcfs/8q24.recode.vcfids.txt"
# 
...
write.table(chr8_ped, filepath_ped, sep=" ")
...
#vcftools --vcf 8q24.recode.vcf --out /users/lgai/8q24_project/data/processed_data/vcfs/8q24.recode.FILTERED --remove ids_with_mend_errors.txt --recode

vcftools --vcf 8q24.recode.vcf --out /users/lgai/8q24_project/data/processed_data/vcfs/8q24.recode.15.mend.error.individuals.removed --remove ids_with_mend_errors.txt --recode

#R

#Get rid of the IDs in the ped file
filepath_ped<-"/users/lgai/8q24_project/data/processed_data/gmkf_euro_completetrios_ids_match_vcf.txt"
chr8_ped<-read.table(filepath_ped)
...
filepath_ids_with_mend_errors<-"/users/lgai/8q24_project/data/raw_data/vcfs/ids_with_mend_errors.txt"
ids_with_mend_errors<-read.table(filepath_ids_with_mend_errors,header=FALSE)
...
write.table(chr8_filt, filepath_ped, sep=" ")
...
chr8_ped<-as.matrix(read.table(filepath_ped))
head(chr8_ped)
